module vorca (clk, i_reset_, i_sw_init, i_addr, i_wr_strb, 
 ...
 n_120_, n_121_, n_122_, n_123_, n_124_, n_125_, n1;
  ...
  NAND2BX1 U75 ( .A(f_state[1]), .B(f_state[0]), .Y(n152) );
  ...
  NAND2BX1 U227 ( .A(n152), .B(f_state[2]), .Y(n156) );
  ...
  NAND2BX4 U242 ( .A(scan_iso_or4), .B(scan_iso_or3), .Y(n380) );
 ...
 scan_iso_or9), .test_si(o_reg_read), .scan_enable(scan_enable) );
  ...
  NAND2BX1 U43 ( .A(scan_iso_or3), .B(scan_iso_or4), .Y(n386) );
  INVX4 U12 ( .A(n131), .Y(n500) );
  OR2X1 U27 ( .A(n379), .B(n500), .Y(n381) );
  NOR2BX2 U202 ( .A(n836), .B(n132), .Y(n134) );
  NOR2BX2 U204 ( .A(n843), .B(n132), .Y(n328) );
  ...
  MX2X2 f32_data_reg_11__ti_over_mux ( .A(n_113_), .B(test_si1), .sel(raw_scan_en), .Y(n1) );
endmodule
module survik (clk, i_reset_, i_sw_init, o_spare_config, 
 ...
 w_load_dbg_config, test_se, test_si, scan_enable;
  ...
  MX2X1 U7 ( .A(o_dbg_config[0]), .B(f32_data[0]), .sel(w_load_dbg_config), .Y(n51) );
