...
// Generated on: Apr 15 2025 17:38:19 IST (Apr 15 2025 12:08:19 UTC)
...
module mcrb(mc_rb_ef1_svld_i, gctl_rclk_orst_n_i, skew_addr_cntr_o,
  ...
  DFFR_X2 \skew_addr_cntr_reg[3] (.RN (gctl_rclk_orst_n_i), .CK
       (mc_rb_ef1_sclk_i), .D (n_13), .Q (skew_addr_cntr_o[3]), .QN
       (UNCONNECTED0));
  ...
  DFFR_X2 \skew_addr_cntr_reg[0] (.RN (gctl_rclk_orst_n_i), .CK
       ...
       (UNCONNECTED3));
  NOR2_X2 g425__2398(.A1 (n_10), .A2 (n_14), .ZN (n_16));
  NOR2_X2 g432__5107(.A1 (n_14), .A2 (skew_addr_cntr_o[0]), .ZN (n_15));
  NOR2_X2 g428__6260(.A1 (n_14), .A2 (n_9), .ZN (n_13));
  NOR2_X2 g433__4319(.A1 (n_14), .A2 (n_2), .ZN (n_12));
  NOR2_X2 g434__8428(.A1 (n_14), .A2 (n_4), .ZN (n_11));
  XNOR2_X2 g427__5526(.A (n_8), .B (skew_addr_cntr_o[4]), .ZN (n_10));
  AOI221_X2 g437__6783(.A (n_6), .B1 (n_5), .B2 (skew_addr_cntr_o[4]),
       .C1 (n_0), .C2 (mc_rb_fuse_vld_q), .ZN (n_14));
  XNOR2_X2 g435__3680(.A (n_7), .B (skew_addr_cntr_o[3]), .ZN (n_9));
  AND2_X2 g436__1617(.A1 (n_7), .A2 (skew_addr_cntr_o[3]), .ZN (n_8));
  AOI21_X2 g438__2802(.A (skew_addr_cntr_o[4]), .B1 (n_5), .B2 (n_1),
       .ZN (n_6));
  XNOR2_X2 g439__1705(.A (n_3), .B (skew_addr_cntr_o[2]), .ZN (n_4));
  AND2_X2 g440__5122(.A1 (n_3), .A2 (skew_addr_cntr_o[2]), .ZN (n_7));
  XNOR2_X2 g441__8246(.A (skew_addr_cntr_o[0]), .B
  ...
  NOR2_X2 g443__7098(.A1 (skew_addr_cntr_o[3]), .A2
       (skew_addr_cntr_o[2]), .ZN (n_5));
  NOR2_X2 g444__6131(.A1 (skew_addr_cntr_o[1]), .A2
       (skew_addr_cntr_o[0]), .ZN (n_1));
  AND2_X2 g445__1881(.A1 (skew_addr_cntr_o[1]), .A2
       (skew_addr_cntr_o[0]), .ZN (n_3));
  INV_X4 g446(.A (mc_rb_ef1_svld_i), .ZN (n_0));
endmodule
