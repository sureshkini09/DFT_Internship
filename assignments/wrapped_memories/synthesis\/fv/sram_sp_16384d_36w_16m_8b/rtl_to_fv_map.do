...
# Generated on: Fri May 02 16:47:46 IST 2025 (Fri May 02 11:17:46 UTC 2025)
...
set_log_file fv/sram_sp_16384d_36w_16m_8b/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/sram_sp_16384d_36w_16m_8b -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/icp/GENUS201/tools.lnx86"
set CDN_SYNTH_ROOT      "/icp/GENUS201/tools.lnx86"
set env(CW_DIR) "/icp/GENUS201/tools.lnx86/lib/chipware"
set CW_DIR      "/icp/GENUS201/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_notranslate_modules -library -both SPRAM_2048x36

add_search_path . /icp/GENUS201/tools.lnx86/lib/tech -library -both
read_library -liberty -both /jk/SCLPDK_V3.0_KIT/scl180/memory/spram/6M1L/SPRAM_2048x36/SPRAM_2048x36_min_SP.lib /home/01fe21bec255/DFT_Internship/assignments/wrapped_memories/synthesis/../../../inputs/lib/slow.lib /jk/SCLPDK_V3.0_KIT/scl180/memory/spram/6M1L/SPRAM_2048x36/SPRAM_2048x36_min_SP.lib /home/01fe21bec255/DFT_Internship/assignments/wrapped_memories/synthesis/../../../inputs/lib/slow.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../scl_2048x36.v
elaborate_design -golden -root {sram_sp_16384d_36w_16m_8b} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/sram_sp_16384d_36w_16m_8b/fv_map.v.gz
elaborate_design -revised -root {sram_sp_16384d_36w_16m_8b}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/sram_sp_16384d_36w_16m_8b/rtl_to_fv_map.log
}
